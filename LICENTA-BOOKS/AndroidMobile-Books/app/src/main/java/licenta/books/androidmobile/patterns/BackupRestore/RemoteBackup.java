...
import static licenta.books.androidmobile.activities.HomeActivity.REQUEST_CODE_CREATION;
import static licenta.books.androidmobile.activities.HomeActivity.REQUEST_CODE_OPENING;
import static licenta.books.androidmobile.interfaces.Constants.DATABASE_NAME;
import static licenta.books.androidmobile.interfaces.Constants.RC_SIGN_IN;
...
public class RemoteBackup {
    ...
    public TaskCompletionSource<DriveId> openItemTaskSource;

    private HomeActivity activity;

    public RemoteBackup(HomeActivity activity){
    ...
    public void connectToDrive(boolean backup) {
        ...
        if (account == null) {
            ...
            driveClient = Drive.getDriveClient(activity, account);
            // Build a drive resource client.
            driveResourceClient = Drive.getDriveResourceClient(activity, account);
            if (backup)
                startDriveBackup();
            else
                startDriveRestore();
